...
type
  ...
  published
    ...
    procedure shouting_a_statement_containing_a_question_mark;
...
procedure BobTest.shouting_a_statement_containing_a_question_mark;
begin
  TapAssertTrue(Self, 'shouting a statement containing a question mark', 'Whoa, chill out!', Bob.response('DO LIONS EAT PEOPLE? AHHHHH.'));
end;
